...
type Predictor interface {
	...
	Predict(jobManager *job_manager.JobsManager, clusterManager *cluster_manager.ClusterManager, allocations []*objects.JobAllocation) (PredictResult, error)

	GetSpaceSharingSets(jobManager *job_manager.JobsManager, clusterManager *cluster_manager.ClusterManager, allocations []*objects.JobAllocation) ([]mapset.Set, error)
	PredictSolely(jobManager *job_manager.JobsManager, clusterManager *cluster_manager.ClusterManager, allocations []*objects.JobAllocation) (PredictResult, error)
